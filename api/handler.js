...
const AUTH_REQUIRED_ROUTES = new Set([
  ...
  'consult-break-glass',
  'investigation-orders', 'prescribing-surveillance', 'prescription-templates', 'cgm-meetings', 'provider-competencies',
...
const ROUTES = {
  ...
  'cron-chime-cleanup':        () => import('./_cron-chime-cleanup.js'),
  'cron-pretriage-cleanup':    () => import('./_cron-pretriage-cleanup.js'),
  ...
  'break-glass':               () => import('./_break-glass.js'),
  'phi-training':              () => import('./_phi-training.js'),
  'disclosures':               () => import('./_disclosures.js'),
  'hl7-audit':                 () => import('./_hl7-audit.js'),
  'cultural-safety-training':  () => import('./_cultural-safety-training.js'),
  'conflict-of-interest':      () => import('./_conflict-of-interest.js'),
  ...
  'prescribing-surveillance':  () => import('./_prescribing-surveillance.js'),
  'prescription-templates':    () => import('./_prescription-templates.js'),
  'cgm-meetings':              () => import('./_cgm-meetings.js'),
