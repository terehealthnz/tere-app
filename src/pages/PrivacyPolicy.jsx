    ...
    <div className="page-shell">
      ...
      <div className="page-content">
        <div className="card" style={{maxWidth:680,margin:'0 auto'}}>
          ...
          {[
            ['1. Who We Are', 'Tere Health Limited is a New Zealand telehealth company providing acute telehealth care to patients in rural and remote New Zealand. Our responsible clinician is Dr Patrick Herling, MBChB, a registered Emergency Medicine physician (MCNZ). Contact: terehealthnz@gmail.com'],
            ...
            ['4. Where It Is Stored', 'All patient data is stored in a secure database in Sydney, Australia (encrypted at rest and in transit). Payment processing is handled by Stripe (PCI-DSS Level 1). Video consultations use end-to-end encrypted WebRTC via LiveKit.'],
          ...
          <div style={{borderTop:'1px solid var(--border)',paddingTop:'1rem',marginTop:'1rem'}}>
            ...
            <p style={{fontSize:'.8125rem',color:'var(--muted)'}}>Tere Health Limited | terehealthnz@gmail.com</p>
          </div>
